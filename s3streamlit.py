...
df = pd.read_csv(r"C:\Users\jersy.carino\Documents\DATA SCIENCE\Sprint3\data\rappler-2024-cleaned-st.csv")
...
if my_page == 'About the data':
    ...
    df = pd.read_csv(r"C:\Users\jersy.carino\Documents\DATA SCIENCE\Sprint3\data\rappler-2024-cleaned-st.csv").sort_values(
    ...
    df = pd.read_csv(r"C:\Users\jersy.carino\Documents\DATA SCIENCE\Sprint3\data\schools-sentiment-labeled.csv").sort_values(
        'date', ascending=False
    )
